...
import {
    postIntelligentRetrievalTrrorismData,
...
export class IntelligentRetrievalTerrorism extends Component {
    ...
    componentDidMount() {
            ...
            // }
            store.dispatch(postIntelligentRetrievalTrrorismData());
        }
        //关键字改变方法
    keywordChange = (value) => {
        this.setState({
    ...
    pageChange(nowPage) {
        ...
        store.dispatch(postIntelligentRetrievalTrrorismData(creds));
    }
    render() {
        let IntelligentRetrievalList = store.getState().IntelligentRetrievalTerrorismList.data.IntelligentRetrievalList.result.list;
        let totalRecord = store.getState().IntelligentRetrievalTerrorismList.data.IntelligentRetrievalList.result.total;
        let nowPage = this.state.nowPage;
        let isFetching = store.getState().IntelligentRetrievalTerrorismList.isFetching;
...
export default connect(mainReducer)(IntelligentRetrievalTerrorism);