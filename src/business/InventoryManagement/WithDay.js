...
export class WithDay extends Component {
        ...
        return (
            <div>
                <div className="marLeft40 z_searchDiv">
                    ...
                    <Input style={{ width: '230px', marginRight: "10px" }} type="text" id='sfzh' placeholder='请输入身份证号' value={sfzh} callbackParent={this.handleSfzhClick} />
                    <label htmlFor="" className="font14">居住类型：</label>
                    <Select key='livetypeselect'
...
WithDay = Form.create()(WithDay);
export default connect(mainReducer)(WithDay);