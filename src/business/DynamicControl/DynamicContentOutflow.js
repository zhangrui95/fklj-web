...
export class DynamicContentOutflow extends Component {
    ...
    componentDidMount() {
        ...
        if(store.getState().routing.locationBeforeTransitions.query.code !== '1021'){
...
const SearchArea = React.createClass({
    getInitialState: function() {
        if(store.getState().routing.locationBeforeTransitions.query.code !== '1033'){
            browserHistory.push({
...
export default connect(mainReducer)(DynamicContentOutflow);