...
export class DynamicContentNotLande extends Component {
    ...
    componentDidMount() {
        ...
        if(store.getState().routing.locationBeforeTransitions.query.code !== '1031'){
...
export default connect(mainReducer)(DynamicContentNotLande);