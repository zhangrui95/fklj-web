...
export class DynamicContentAbnormal extends Component {
    ...
    //     if(store.getState().DynamicControl.uiData.menus[0].menuName!=="全部"){
    //         alert('jinru');
    //         browserHistory.replace('/DynamicControl') 
    //     }
...
export default connect(mainReducer)(DynamicContentAbnormal);