...
export class PointFinishTask extends Component {
                                ...
                                <Col span={24}>
                                    ...
                                    >
                                        {getFieldDecorator('lower_hair_type', {
                                            ...
                                            <RadioGroup onChange={this.onRadioChange} disabled>
                                                <Radio value={'0'}>仅自身节点</Radio>
                                                <Radio value={'1'}>仅子节点</Radio>
                                                <Radio value={'2'}>自身及子节点</Radio>
                                            </RadioGroup>
                                ...
                                <Col span={24} className="selectHeight">
                                    ...
                                    >
                                        {getFieldDecorator('police_unit_code_jsonb', {
                                            ...
                                            initialValue: byidObj ? byidObj.police_unit_code_jsonb : [],
                                            validateFirst: true
                                        })(
                                            <TreeSelect
                                                style={{ fontSize: '14px' }}
                                ...
                                <Col span={24} className="selectHeight">
                                    ...
                                    >
                                        {getFieldDecorator('checknation_id', {
                                            ...
                                            initialValue: byidObj ? byidObj.checknation_id : [],
                                            validateFirst: true
                                        })(
                                            <TreeSelect
                                                style={{ fontSize: '14px' }}
...
PointFinishTask = Form.create()(PointFinishTask);
export default connect(mainReducer)(PointFinishTask);