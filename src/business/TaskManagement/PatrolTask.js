...
export  class PatrolTask extends Component{
    ...
    render() {
        ...
        const data = [
            {key: 1, serial: 1, content:'', label: '我的任务001', startTime: '2018-01-10 01:32:12',endTime: '2018-03-12 12:10:29',status: '进行中',treeValue: [{value: "ec02ed04ad6147b7a421ab912a7cf6b6"}]},
            {key: 2, serial: 2, content:'hylink任务的描述', label: 'hylink任务', startTime: '2017-12-09 13:30:00',endTime: '2018-04-10 22:00:00',status: '进行中',treeValue: [{value: "ec02ed04ad6147b7a421ab912a7cf6b6"}, {value: "f24c58a0aadb42ca826c02c26f74a461"}]},
            {key: 3, serial: 3, content:'', label: '海邻科任务', startTime: '2018-02-18 14:50:32',endTime: '2018-02-07 18:12:59',status: '进行中',treeValue: [{value: "ec02ed04ad6147b7a421ab912a7cf6b6"}]},
        ];
        const rowSelection = {
