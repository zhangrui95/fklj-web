...
moment.locale('zh-cn');
// import {findDeptTree} from "../../actions/ChoiceSystemment";
...
export  class ChoiceSystem extends Component{
    ...
    editShowModal = (record) => {
        ...
        this.treeData = [];
        const list = store.getState().ChoiceSystemment.data.FindTreeList.result.list
...
ChoiceSystem = Form.create()(ChoiceSystem);
export default connect(mainReducer)(ChoiceSystem);