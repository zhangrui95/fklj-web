...
export  class NotControlled extends Component{
    constructor(props) { //初始化nowPage为1
        ...
        this.state = {
            ...
            data: [
                ...
                {key: 5, serial: 5, cardId: '230105199605262631', label: '李四', sex:'女',age:'18', state:'暂住', phone:'13936003633',zrdw:'呼伦浩特市XX单位', updatetime: '2018-04-09',cycle:'按天',address:'玉泉区兴隆巷1106号'},
                {key: 6, serial: 6, cardId: '20610819740122292X', label: '王二', sex:'男',age:'39', state:'暂住', phone:'13936003633',zrdw:'呼伦浩特市XX单位', updatetime: '2018-04-08',cycle:'按天',address:'玉泉区兴隆巷1106号'},
            ],
            record: null,
...
NotControlled = Form.create()(NotControlled);
export default connect(mainReducer)(NotControlled);