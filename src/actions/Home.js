...
// 呼市反恐首页
// 拟来呼人员
export const NILAIHURENYUAN_DATA = 'nilsihurenyuan_data';
export const NILAIHURENYUAN_ERROR = 'nilsihurenyuan_error';
export function postNilaihurenyuanData(creds) {
    let path = '/data/getQianStatistics';
    return dispatch => {
        dispatch({ type: "REQUEST_NILAIHURENYUAN_REPORT" });
        post(api + path, creds).then((json) => {
            dispatch(receivedNilaihurenyuanData(json));
        }).catch((e) => {
            dispatch(receivedNilaihurenyuanError(e.toString()))
        });
    }
}
export function receivedNilaihurenyuanData(data) {
    return { type: NILAIHURENYUAN_DATA, data: data }
}
export function receivedNilaihurenyuanError(message) {
    return { type: NILAIHURENYUAN_ERROR, message: message }
}
// 管控人员
...
export function postHomeControlPeson_hushi_Data(creds) {
    ...
    return dispatch => {
        ...
        post(api + path, creds).then((json) => {
            dispatch(receivedtHomeControlPeson_hushi_Data(json));
        }).catch((e) => {
            dispatch(receivedHomeControlPeson_hushi_Error(e.toString()))
        });
    }
}
export function receivedtHomeControlPeson_hushi_Data(data) {
    return { type: HOMECONTROLPERSON_HUSHI_DATA, data: data }
}
export function receivedHomeControlPeson_hushi_Error(message) {
    return { type: HOMECONTROLPERSON_HUSHI_ERROR, message: message }
}
// 派出所任务统计
...
export function postPoliceStation_hushi_Data(creds) {
    ...
    return dispatch => {
        ...
        post(api + path, creds).then((json) => {
            dispatch(receivedtPoliceStation_hushi_Data(json));
        }).catch((e) => {
            dispatch(receivedPoliceStation_hushi_Error(e.toString()))
        });
    }
}
export function receivedtPoliceStation_hushi_Data(data) {
    return { type: POLICESTATION_HUSHI_DATA, data: data }
}
export function receivedPoliceStation_hushi_Error(message) {
    return { type: POLICESTATION_HUSHI_ERROR, message: message }
}
// 已盘查任务
...
export function postHaveBeenchecked_hushi_Data(creds) {
    ...
    return dispatch => {
        ...
        post(api + path, creds).then((json) => {
            dispatch(receivedtHaveBeenchecked_hushi_Data(json));
        }).catch((e) => {
            dispatch(receivedHaveBeenchecked_hushi_Error(e.toString()))
        });
    }
}
export function receivedtHaveBeenchecked_hushi_Data(data) {
    return { type: HAVEBEENCHECKED_HUSHI_DATA, data: data }
}
export function receivedHaveBeenchecked_hushi_Error(message) {
    return { type: HAVEBEENCHECKED_HUSHI_ERROR, message: message }
}
